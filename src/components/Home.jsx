    ...
    <>
      ...
      <div className="wrapper">
       ...
       <div className="headerDiv">
        ...
        <p>
          <a href="index.html" className="  btn headerBtn ">Start Now</a>
        ...
        <div>
           <img src="https://res.cloudinary.com/blackgirlmagic/image/upload/v1679469937/ShowHub/image-removebg-preview_23_qvqkhx.png" alt="people watching movie" className="header-image" /> 
        </div>
       </div>
      </div>
