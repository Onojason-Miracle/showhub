...
function Movies() {
  ...
  useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/discover/movie?api_key=0c8d9eb082bdb49bc2a86e9312bf02df&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=6&with_watch_monetization_types=flatrate`
    )
  ...
  return (
    <>
      ...
      <div className="pages">
        ...
        <p id="other-page">
          <Link className="link" id="active-page" to="/page6">
            6
          </Link>
        </p>
      </div>
